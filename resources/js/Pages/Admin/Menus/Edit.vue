...
<template>
  <Head title="Edit a Menu Item" />

  <AppLayout>
    <div class="max-w-xl mx-auto p-4">
      <h1 class="text-2xl font-bold mb-4">Edit a Menu Item</h1>
      ...
      <form @submit.prevent="submit" class="space-y-4">
        ...
        <div>
          ...
          <select v-model="form.parent_id" class="mt-1 w-full rounded border p-2">
            ...
            <option v-for="menu in props.parentMenus" :key="menu.id" :value="menu.id">
              {{ menu.name }}
            </option>
          </select>
        ...
        <div>
          ...
          <a href="/admin/menus" class="ml-2 bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400">
            Cancel
          </a>
        </div>
      </form>
